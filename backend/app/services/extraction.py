...
from app.services import entity_extraction, icd10_mapping, knowledge_base, summary_generation
...
def build_result(
    ...
    *,
    ...
    try:
        groups = knowledge_base.enhance_groups(groups)
    except Exception:
        logger.exception("Local knowledge retrieval failed; using unenhanced entities")
    ...
    return ExtractionResult(
        ...
        patient_summary=summary_generation.generate_patient_summary(groups, note_text),
...
def extract(text: str) -> ExtractionResult:
    ...
    try:
        ...
        groups = EntityGroups()
    return build_result(groups, model_name=MODEL_NAME, note_text=text)
